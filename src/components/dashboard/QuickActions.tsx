          ...
          {actions.map((action, index) => {
            ...
            return (
              <Button
                key={index}
                variant="outline"
                className="h-auto p-4 flex flex-col items-center space-y-2 hover:shadow-md transition-all duration-200 border-0 bg-gradient-to-br from-gray-50 to-white"
